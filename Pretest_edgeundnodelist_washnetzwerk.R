...
el <- read.csv("https://raw.githubusercontent.com/hdm-sw184/Die-magische-Sieben/master/EdgelistPretest.csv", header=T, as.is=T, sep = ",")
nl <- read.csv("https://raw.githubusercontent.com/hdm-sw184/Die-magische-Sieben/master/NodelistPretest.csv", header=T, as.is=T, sep = ",")
...
tutgraph <- graph_from_data_frame(d=mel,directed=T)
